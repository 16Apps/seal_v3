app.controller('equipamentoCtrl', function ($scope, $http, params, uteisService) {

    $scope._regConta = {};
    $scope._regColaborador = []
    $scope._listEquipamentos = []
    ...
    $scope.onCarregaRegistros = async function () {
        ...
        let _url = '/_bd?c=equipamento&id_conta=' + $scope._regConta._id 
    ...
    $scope.onEquipamento = async function (_acao, _edit) {
        ...
        if (modalInstance != undefined) {
            ...
            modalInstance = new bootstrap.Modal(document.getElementById('modalEquipamento'));
            modalInstance.show();
        }
